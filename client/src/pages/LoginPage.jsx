...
const LoginPage = () => {
  ...
  const onSubmitHandler = (event) => {
    ...
    // For signup, ensure bio is filled before submitting
    if (currentState === 'Sign up' && isDataSubmitted && !bio) {
  ...
  return (
    <div className="min-h-screen bg-cover bg-center flex 
      items-center gap-8 sm:justify-evenly max-sm:flex-col
      backdrop-blur-2xl">
      ...
      {/* --------------right------------------- */}
      <form onSubmit={onSubmitHandler} className='border-2 bg-gradient-to-r from-purple-400 to-violet-600 text-white border-gray-500 p-6 flex flex-col gap-6 rounded-lg shadow-lg'>
          ...
          <div className='flex flex-col gap-2 '>
            {currentState === "Sign up" ? (
              ...
              <span onClick={() => {setcurrentState("Sign up"); setIsDataSubmitted(false)}}
