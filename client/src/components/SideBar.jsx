...
const SideBar = () => {
  ...
  return (
    <div className={`
          bg-[#8185B0]/ backdrop-blur-lg h-full p-5 rounded-r-xl overflow-y-scroll text-white
          ${selectedUser ? "max-md:hidden" : ''}`}>
        <div className="pb-5">

          {/* Top quick chat and menu bar*/}
          ...
          {/* Search bar*/}
          <div className = 'bg-[#282145] rounded-full flex items-center gap-2 py-3 px-4 mt-5'>
          ...
          <div className="flex flex-col">
            ...
            {filteredUsers.map((user, index) => {
              console.log('User:', user.fullName, 'ID:', user._id, 'Is Online:', onlineUsers.includes(user._id));
              return (
                <div
                  ...
                  className={`relative flex items-center gap-2 p-2 pl-4
                    ...
                    ${selectedUser && selectedUser._id === user._id ? 'bg-[#282142]/50' : ''}
                  `}
                >
